 ...
 */
function Tithe() {
    this.path = Ul.USER_DIR + "/.tithe.json";
}
 ...
 * @return {Tithe} The `Tithe` instance.
 */
Tithe.prototype.getData = function (options, callback) {
 ...
 * @return {Tithe} The `Tithe` instance.
 */
Tithe.prototype.read = function (callback) {
 ...
 * @return {Tithe} The `Tithe` instance.
 */
Tithe.prototype.write = function (content, callback) {
 ...
 * @return {Tithe} The `Tithe` instance.
 */
Tithe.prototype.insert = function (data, callback) {
 ...
 * @return {Tithe} The `Tithe` instance.
 */
Tithe.prototype.pay = function (callback) {
    var self = this;
    ...
    self.getData(function (err, tData) {
        if (err) { return callback(err); }
        self.insert({
            val: -tData.total
 ...
 * @return {Tithe} The `Tithe` instance.
 */
Tithe.prototype.setCurrency = function (newCurrency, callback) {
    var self = this;
